...
<div class="panel-default clearfix">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <textarea id="campaign_desc" rows="5" cols="30" ></textarea>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <select id="belong_to_advertiser" >
                ...
                <option value=<?=$val['entry_id'] ?>><?=$val['name_zh'] ?></option>
                <?php endforeach;?>            
            </select>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php foreach ($creativeShowRule as $key=> $val): ?>
                ...
                <input type="radio" name="creative_show_rule" value=<?=$key ?>> <?=$val ?>
                </div>
            <?php endforeach;?>   
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" id="campaign_date_range" class="daterange-form" >
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <div class="radio-horizontal">
                <input type="radio" id="time_all" name="choose_time_type" checked="checked"> 所有时间
            </div>
            <div class="radio-horizontal">
                <input type="radio" id="time_some" name="choose_time_type"> 指定时间
            </div>
            ...
            <ul class="list-inline choose_time hidden clearfix" id="choose_time" style="clear: both">
                ...
                <li>17</li><li>18</li><li>19</li><li>20</li><li>21</li><li>22</li><li>23</li>
            </ul>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text"  min="1" max="10000000000" value="" id="total_amount"  >
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php foreach ($displayWay as $key=> $val): ?>
                <div class="radio-horizontal">
                <input type="radio" name="campaign_display_way" value=<?=$key ?>> <?=$val ?>
                </div>
            <?php endforeach;?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <div class="radio-horizontal">
                <input type="radio" onclick="document.getElementById(&#39;country_target&#39;).style.display=&#39;none&#39;;" name="geo_targeting" id="geo_targeting_all" value="1" checked="checked"> 所有地区
            </div>
            <div class="radio-horizontal">
                <input type="radio" onclick="document.getElementById(&#39;country_target&#39;).style.display=&#39;block&#39;;" name="geo_targeting" id="geo_targeting_co" value="2"> 指定地区
            </div>
        </div>
    </div>
    ...
    <div class="control-group hidden-group">
        <div class="col-sm-10 col-sm-offset-2">
            <div id="country_target" class="clearfix" style="display: none;">
    ...
    <div class="control-group">
        ...
        <div class="col-sm-8">
            <div id="country_target" class="clearfix">
							...
							<?php foreach ($zonesList as $val):?>
							     ...
							     <tr class="odd">
									...
									<?php foreach ($val['zones'] as $val2):?>
									   <div><input value="<?=$val2['entry_id'] ?>" class="pub_<?=$val['media_id'] ?>" name="placement_select[ ]" type="checkbox" onclick="click_placement_checkbox(this);"><?=$val2['zone_name'].'('.$val2['name'].')' ?></div>
									<?php endforeach; ?>
									</td>
								</tr>
								<?php endif;?>
                ...
                <input type="hidden" value="" id="publication_selected_ids">
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    //投放地区
    var selecteddata = {items: []};    var location_data = {items:<?=$area ?>};
    //已经选择的地区
    ...
    function selectAllDateInRange() {
        ...
        while (timeNow.getTime() <= timeCampaignEnd) {
            ...
            var date = year + '-' + month + '-' + timeNow.getDate();
    ...
    function checkDate(date) {
        ...
        var timeChooseDate = new Date(date.split('_')[0], parseInt(date.split('_')[1]) - 1, date.split('_')[2]).getTime();
