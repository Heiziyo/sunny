...
class ThriftHiveClient extends \metastore\ThriftHiveMetastoreClient implements \Hive\ThriftHiveIf {
  ...
  {
    $args = new \Hive\ThriftHive_execute_args();
    $args->query = $query;
  ...
  public function recv_execute()
  {
    ...
    else
    {
      ...
      $result = new \Hive\ThriftHive_execute_result();
  ...
  {
    $args = new \Hive\ThriftHive_fetchOne_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  public function recv_fetchOne()
  {
    ...
    else
    {
      ...
      $result = new \Hive\ThriftHive_fetchOne_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
  ...
  {
    $args = new \Hive\ThriftHive_fetchN_args();
  ...
  public function recv_fetchN()
  {
    ...
    else
    {
      ...
      $result = new \Hive\ThriftHive_fetchN_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Hive\ThriftHive_fetchAll_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  public function recv_fetchAll()
  {
    ...
    else
    {
      ...
      $result = new \Hive\ThriftHive_fetchAll_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Hive\ThriftHive_getSchema_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  public function recv_getSchema()
  {
    ...
    else
    {
      ...
      $result = new \Hive\ThriftHive_getSchema_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Hive\ThriftHive_getThriftSchema_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  public function recv_getThriftSchema()
  {
    ...
    else
    {
      ...
      $result = new \Hive\ThriftHive_getThriftSchema_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Hive\ThriftHive_getClusterStatus_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  public function recv_getClusterStatus()
  {
    ...
    else
    {
      ...
      $result = new \Hive\ThriftHive_getClusterStatus_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Hive\ThriftHive_getQueryPlan_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  public function recv_getQueryPlan()
  {
    ...
    else
    {
      ...
      $result = new \Hive\ThriftHive_getQueryPlan_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
  ...
  {
    $args = new \Hive\ThriftHive_clean_args();
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  public function recv_clean()
  {
    ...
    else
    {
      ...
      $result = new \Hive\ThriftHive_clean_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    return;
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->ex = new \Hive\HiveServerException();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \QueryPlan\QueryPlan();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
