      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem18 = null;
              $elem18 = new \QueryPlan\Adjacency();
      ...
      switch ($fid)
      {
        ...
        case 5:
          if ($ftype == TType::STRUCT) {
            $this->operatorGraph = new \QueryPlan\Graph();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 5:
          if ($ftype == TType::STRUCT) {
            $this->stageGraph = new \QueryPlan\Graph();
