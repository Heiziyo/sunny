...
interface ThriftHiveMetastoreIf extends \Facebook\FacebookServiceIf {
  ...
  public function create_function(\metastore\CFunction $func);
  public function drop_function($dbName, $funcName);
  public function alter_function($dbName, $funcName, \metastore\CFunction $newFunc);
...
class ThriftHiveMetastoreClient extends \Facebook\FacebookServiceClient implements \metastore\ThriftHiveMetastoreIf {
  ...
  public function send_create_function(\metastore\CFunction $func)
  {
  ...
  public function send_alter_function($dbName, $funcName, \metastore\CFunction $newFunc)
  {
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->func = new \metastore\CFunction();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::STRUCT) {
            $this->newFunc = new \metastore\CFunction();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \metastore\CFunction();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
